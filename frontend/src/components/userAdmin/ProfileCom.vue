  ...
  <div class="profile-back">
    <div class="profile-left">
      ...
      <nav class="sidebars">
        <ul>
          <li>
            <router-link to="/profile-admin/link"
              ><i class="fas fa-tachometer-alt"></i>Посилання на
              адмін-панель</router-link
            >
          </li>
          <li>
            <router-link to="/profile-admin/settings"
              ><i class="fas fa-cogs"></i>Налаштування профілю</router-link
            >
          </li>
        </ul>
      </nav>
    ...
    getuserPhoto(photo) {
      try {
        const photoPath = photo
          ? photo.split("media/images/profile_images/")[1]
          : null;
        return photoPath
          ? require(`@/../../backend/media/images/profile_images/${photoPath}`)
